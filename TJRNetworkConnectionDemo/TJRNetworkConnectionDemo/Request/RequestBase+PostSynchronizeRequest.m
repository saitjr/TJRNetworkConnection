//
//  RequestBase+PostSynchronizeRequest.m
...
@implementation RequestBase (PostSynchronizeRequest)

+ (void)postRequestWithLat:(NSString *)lat lon:(NSString *)lon source:(NSString *)source count:(NSString *)count callback:(Callback)callback {
